        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <img
              ...
              alt="SankaraNarayanan Saminathan"
              className="p-12 w-70 h-70 transform translate-y-[-12%]"
              title="SankaraNarayanan Saminathan"
            />
          </motion.div>
          <motion.div
            className=""
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              ...
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>A206, KG
                Smart City Apartment, Coimbatore
              </h2>
              <a
                href="https://drive.google.com/file/d/1GHHE5xd7cPcUOrwTboKdyJT23UiaHf_b/view?usp=drive_link"
                target="blank"
              >
